...
> P6 会话协调器、客户端安全 terminal-observation/Error-cleanup/间接重入收口、ledger-first proposal review、P6-A0/A1a/A1b token-reservation/physical-retry budget Contract、受限 Technique→Action permit Contract 与 P5D-A0/A1/A2 有界蓝图/施工工作包/candidate-site 数据 Contract
