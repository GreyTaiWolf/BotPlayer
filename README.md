...
> P6 会话协调器、客户端安全 terminal-observation/Error-cleanup/间接重入收口、ledger-first proposal review Contract、受限 Technique→Action permit Contract 与 P5D-A0/A1 有界蓝图/施工工作包数据 Contract
