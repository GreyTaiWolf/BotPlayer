...
| 玩家技术动作、跳劈、走位、真实施工 | `technique/`、`building/blueprint/`（仅有界纯 Java 蓝图 DTO）与现有 `action/`、`navigation/`、`safety/` | ADR-0017、ADR-0029、`PLAYER_TECHNIQUE_BUILDING_COMBAT_DESIGN_CN.md`；不得复制 Action/Skill runtime，也不得把蓝图 DTO 当作世界动作入口 |
