...
> ledger-first proposal review、P6-A0 token-reservation ledger Contract 和 P5D-A0/A1 有界蓝图/施工工作包数据 Contract 仍待各自 Java 21 CI；P5 的通用生存能力和 P6 的通用
