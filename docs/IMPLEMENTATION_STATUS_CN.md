...
> physical-attempt handshake、P6-B1 mock payload-path GameTest 源和 P5D-A0/A1/A2/A3/A4/A4-R1/A5/A6/A7 有界蓝图/施工工作包/candidate-site/survey-assessment/placeable-item/default-state registry/loaded-world survey/spatial-lease/own-inventory-material observation 数据 Contract 仍待各自 Java 21 CI；P5 的通用生存能力和 P6 的通用
