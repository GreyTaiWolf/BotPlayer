...
> ledger-first proposal review、P6-A0/A1a/A1b token-reservation/physical-retry budget Contract 和 P5D-A0/A1/A2/A3/A4 有界蓝图/施工工作包/candidate-site/survey-assessment/placeable-item 数据 Contract 仍待各自 Java 21 CI；P5 的通用生存能力和 P6 的通用
