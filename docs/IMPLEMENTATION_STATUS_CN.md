...
> P6-R1 的先前基线。当前分支的 P5A 修复、P5C 单 lifecycle Contract、P6 会话协调器、本地
> ledger-first proposal review、P6-A0/A1a token-reservation/physical-retry budget Contract 和 P5D-A0/A1 有界蓝图/施工工作包数据 Contract 仍待各自 Java 21 CI；P5 的通用生存能力和 P6 的通用
