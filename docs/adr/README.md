...
| ADR-0007 | 默认有限感知，不做全知 bot | Accepted | ADR-0013 细化；P3 候选待 CI |
...
| [ADR-0013](0013-finite-perception-two-plane-world-model.md) | 有限感知、双事件平面与有界世界模型 | Accepted | P3 候选实现已编码，待 Java 21 CI 验证 |
