...
ledger-first proposal review、P6-A0/A1a/A1b token-reservation/physical-retry budget 与 P5D-A0/A1/A2 有界蓝图/施工工作包/candidate-site 数据增量提交之前的自动化基线；这些提交仍须各自通过 Java 21 CI。涉及
Minecraft 行为的提交必须运行：
