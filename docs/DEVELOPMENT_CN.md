...
ledger-first proposal review、P6-A0/A1a/A1b token-reservation/physical-retry budget 与 P5D-A0/A1/A2/A3 有界蓝图/施工工作包/candidate-site/survey-assessment 数据增量提交之前的自动化基线；这些提交仍须各自通过 Java 21 CI。涉及
Minecraft 行为的提交必须运行：
...
src/main/java/io/github/greytaiwolf/botplayer/
  ...
  building/site/                 P5D-A2 candidate anchor/derived-bounds/work-plan binding，A3 caller-supplied exact target evidence 的 fail-closed assessment；不读 world，也不表示 lease/许可/material/placement/Technique/Action
